/**
 * The public page for the Spiritual Data Prize for Proof of the Paranormal, rendered at
 * /initiatives/psychic-ability-certification/prize.
 *
 * The text lives in ../../../data/paranormalPrizeData.ts; this file only
 * renders it, in the same document layout the published protocol uses, so the
 * prize reads as part of the same standard rather than as marketing beside it.
 */
...
import {
  prizeHeaderData,
  paranormalPrizeAmount,
  paranormalPrizeMeta,
  paranormalPrizeSections,
} from "../../../data/paranormalPrizeData";
...
const Prize: React.FC = () => {
  ...
  return (
    <>
      <HeaderSection data={prizeHeaderData} />
        ...
        <Container>
          ...
          >
            ...
            <Box component="ol" sx={{ listStyle: "none", m: 0, p: 0 }}>
              {paranormalPrizeSections.map((section) => (
          ...
          <Box component="article" sx={{ maxWidth: DOC_MAX_WIDTH }}>
            {paranormalPrizeSections.map((section, sectionIndex) => (
              <Box
                key={section.id}
                component="section"
                id={section.id}
          ...
          >
            ...
            >
              {paranormalPrizeAmount} plus travel costs, open to anyone
            </Typography>
            <Typography
              sx={{ opacity: 0.85, lineHeight: 1.9, maxWidth: 760, mb: 3 }}
            >
              There is no entry fee and no cost to take part. We arrange the
              assessment in your location and find the witnesses there.
              Applying begins a screening conversation, not a test, and every
              applicant is eligible for the prize without doing anything
              additional. Researchers who want to observe a session or tighten
              a control are as welcome as applicants are.
            </Typography>
