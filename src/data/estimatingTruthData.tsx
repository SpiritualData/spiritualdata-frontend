...
export const headerData = {
  image: bannerImage,
  heading: "Truth Estimation",
  desc: "A transparent AI framework that estimates truth from evidence and collaboration, forming the backbone of Spiritual Data's products.",
};
...
export const scrollCardsData = [
  ...
  {
    title: "Purpose",
    desc: "Provide an AI automation framework that leverages the benefits of LLMs to make decisions based on all relevant data, especially for scientific conclusions. This framework also enables open collaboration with researchers, domain experts, and the public to validate both the data and methodology.",
    btn: "Explore Research Impact",
    img: scrollimage2,
    link: "/change",
  },
  {
...
export const estimatingTruthDetailsData = [
  {
    id: 1,
    title: "Evidential Data",
    desc: "Evidential data (research papers, experiences) are imported into a knowledge graph of concepts.",
    secHead: "DETAILS",
    secSubHead1: "TRUTH",
  ...
  },
  {
    ...
    desc: "Depending on the hypothesis, relevant domains run automation to determine the likelihood of truth.",
    secHead: "DETAILS",
    secSubHead1: "TRUTH",
    secSubHead2: "ESTIMATION",
  },
  {
    ...
    desc: "A confidence level is determined based on curated datasets and evidence in the knowledge graph.",
    secHead: "DETAILS",
    secSubHead1: "TRUTH",
    secSubHead2: "ESTIMATION",
  },
  {
    ...
    desc: "This framework provides the foundation of science and statistical justification for Spiritual Data's AI products and recommendations.",
    secHead: "DETAILS",
    secSubHead1: "TRUTH",
    secSubHead2: "ESTIMATION",
  },
