            ...
            {inView && (
              <Fade in={true} timeout={2000}>
                ...
                >
                  ...
                  authority, just as they had been for Spiritual Data's founder,
                  despite higher education. Most people don't realize that
                  parapsychology researchers have already uncovered evidence
                  that could radically reshape the world's spiritual beliefs,
                  but if understood.
                  <br />
                  <br />
                  In 2014, scientists openly called for moving past the limits
                  of the materialist paradigm, which leaves spirituality out of
                  science and punishes dissent. But at Spiritual Data, we don't
                  claim to have the answers, but we let the evidence speak. Our
                  AI algorithm is built to be unbiased, data-driven, and open.
                  So you can explore what's most likely true.
                </Typography>
              </Fade>
            )}
