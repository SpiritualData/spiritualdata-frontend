...
let infoTracking = false;

const Outcome: React.FC<OutcomeProps> = ({ title, additional_info }) => {
  const [open, setOpen] = useState(false);
  const suggestions = additional_info?.plan?.map(
